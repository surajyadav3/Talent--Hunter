...
import { ChevronDownIcon, ChevronRightIcon, Code2Icon, LockIcon, SparklesIcon, SearchIcon } from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    <div className="relative w-full max-w-md">
                        ...
                        <input
                            ...
                            className="input input-bordered w-full pl-12 h-14 bg-base-100/50 backdrop-blur-sm border-base-300 focus:border-primary focus:ring-1 focus:ring-primary rounded-2xl shadow-sm transition-all text-base"
                            value={searchQuery}
                        ...
                        {searchQuery && (
                            <button
                                ...
                                className="absolute inset-y-0 right-4 flex items-center text-base-content/40 hover:text-base-content transition-colors"
                            >
                                <span className="text-xs font-bold bg-base-300 px-1.5 py-0.5 rounded">ESC</span>
                            </button>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    {problems.length === 0 ? (
                        <div className="text-center py-20 bg-base-100 rounded-3xl border border-dashed border-base-300">
                            <div className="size-20 bg-base-200 rounded-full flex items-center justify-center mx-auto mb-6">
                                <SearchIcon className="size-10 text-base-content/20" />
                            </div>
